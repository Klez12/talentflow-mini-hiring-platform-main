            ...
            <div className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                  {/* Contact Information */}
                  <div className="bg-gradient-to-br from-blue-50 via-fuchsia-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl p-7 shadow-xl border border-fuchsia-200 dark:border-fuchsia-700">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Contact Information</h3>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-gradient-to-br from-blue-400 via-fuchsia-400 to-indigo-500 dark:from-blue-900 dark:via-fuchsia-900 dark:to-indigo-900 rounded-xl flex items-center justify-center shadow-md">
                          <EnvelopeIcon className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <p className="text-base text-gray-500 dark:text-gray-400 font-semibold">Email</p>
                          <a
                            href={`mailto:${candidate.email}`}
                            className="text-indigo-700 dark:text-fuchsia-300 hover:text-fuchsia-600 dark:hover:text-fuchsia-400 font-bold transition-colors"
                          >
                            {candidate.email}
                          </a>
                        </div>
                      ...
                      <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-gradient-to-br from-green-400 via-blue-400 to-indigo-500 dark:from-green-900 dark:via-blue-900 dark:to-indigo-900 rounded-xl flex items-center justify-center shadow-md">
                          <PhoneIcon className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <p className="text-base text-gray-500 dark:text-gray-400 font-semibold">Phone</p>
                          <a
                      ...
                      <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-gradient-to-br from-orange-400 via-fuchsia-400 to-indigo-500 dark:from-orange-900 dark:via-fuchsia-900 dark:to-indigo-900 rounded-xl flex items-center justify-center shadow-md">
                          <BriefcaseIcon className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <p className="text-base text-gray-500 dark:text-gray-400 font-semibold">Applications</p>
                          <p className="text-indigo-700 dark:text-fuchsia-300 font-bold">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div className="bg-gradient-to-br from-indigo-50 via-fuchsia-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-lg p-4 max-h-40 overflow-y-auto border border-fuchsia-100 dark:border-fuchsia-700 shadow-md">
                    ...
                    {filteredApplications.length > 0 ? (
                      <div className="space-y-4 max-h-80 overflow-y-auto">
                        {filteredApplications.map((application) => {
                          ...
                          return (
                            <div key={application.id} className="border border-fuchsia-200 dark:border-fuchsia-700 rounded-xl p-5 bg-gradient-to-br from-blue-50 via-fuchsia-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 shadow-lg transition-all duration-200 hover:shadow-xl">
                              {/* Application Header */}
