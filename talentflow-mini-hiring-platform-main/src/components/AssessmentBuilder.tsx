    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-4xl font-extrabold text-purple-700 dark:text-purple-400 mb-2 tracking-tight drop-shadow-lg">
              {assessment.id ? 'Edit Assessment' : 'Create Assessment'}
            </h2>
            {assessment.id && (
              <p className="text-lg text-purple-700 dark:text-purple-400 font-medium mt-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 via-blue-500 to-indigo-700 dark:from-fuchsia-400 dark:via-blue-400 dark:to-indigo-500">Assessment Details</h3>
                {assessment.id && (
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-bold text-fuchsia-700 dark:text-fuchsia-300 mb-2">Title</label>
                  <input
                    type="text"
                    className="w-full px-3 py-2 border-none rounded-xl bg-gradient-to-r from-[#0a1128] via-blue-800 to-indigo-900 text-white placeholder-fuchsia-200 focus:ring-2 focus:ring-fuchsia-500 shadow-md transition-colors font-bold"
                    style={{background: 'linear-gradient(90deg, #0a1128 0%, #1e3a8a 50%, #312e81 100%)'}}
                ...
                <div>
                  <label className="block text-sm font-bold text-fuchsia-700 dark:text-fuchsia-300 mb-2">Description</label>
                  <textarea
                    className="w-full px-3 py-2 border-none rounded-xl bg-gradient-to-r from-[#0a1128] via-blue-800 to-indigo-900 text-white placeholder-fuchsia-200 focus:ring-2 focus:ring-fuchsia-500 shadow-md transition-colors font-bold"
                    style={{background: 'linear-gradient(90deg, #0a1128 0%, #1e3a8a 50%, #312e81 100%)'}}
                ...
                <div>
                  <label className="flex items-center text-sm font-bold text-fuchsia-700 dark:text-fuchsia-300">
                    <input
                      type="checkbox"
            ...
            <div className="space-y-4">
              {assessment.sections.map((section, sectionIndex) => (
                <div
                  key={section.id}
                  className="bg-gradient-to-br from-blue-50 via-fuchsia-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl shadow-xl border border-fuchsia-200 dark:border-fuchsia-700 p-6"
                >
                  <div className="flex items-center justify-between mb-4">
                    <input
                      type="text"
                  ...
                  <div className="space-y-4">
                    {section.questions.map((question, questionIndex) => (
                      <div
                        key={question.id}
                        className="bg-gradient-to-br from-blue-50 via-fuchsia-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl p-5 border border-fuchsia-200 dark:border-fuchsia-700 shadow-xl transition-all duration-200 hover:shadow-2xl"
                      >
                        <div className="flex items-center justify-between mb-3">
                          <select
                            className="px-3 py-2 border-none rounded-xl bg-gradient-to-r from-[#0a1128] via-blue-800 to-indigo-900 text-white focus:ring-2 focus:ring-fuchsia-500 shadow-md transition-colors [&>option]:bg-[#0a1128] [&>option]:text-white font-bold"
                            style={{background: 'linear-gradient(90deg, #0a1128 0%, #1e3a8a 50%, #312e81 100%)'}}
                            value={question.type}
                              ...
                              <div className="space-y-2">
                                {question.options?.map((option, optionIndex) => (
                                  <div key={optionIndex} className="flex gap-2">
                                    <input
                                      type="text"
                                      className="flex-1 px-3 py-2 border-none rounded-xl bg-gradient-to-r from-[#0a1128] via-blue-800 to-indigo-900 text-white placeholder-fuchsia-200 focus:ring-2 focus:ring-fuchsia-500 shadow-md transition-colors font-bold"
                                      style={{background: 'linear-gradient(90deg, #0a1128 0%, #1e3a8a 50%, #312e81 100%)'}}
                                      value={option}
                                      onChange={(e) => {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 h-fit sticky top-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-fuchsia-500 to-indigo-700 dark:from-purple-400 dark:via-fuchsia-400 dark:to-indigo-500">Assessment Overview</h3>
            ...
            <div className="space-y-6 max-h-96 overflow-y-auto">
              {assessment.title && (
                <h2 className="text-xl font-bold text-purple-700 dark:text-purple-300 mb-2">{assessment.title}</h2>
              )}
              {assessment.description && (
                <p className="text-purple-700 dark:text-purple-300 mb-4">{assessment.description}</p>
              )}

              {assessment.sections.map((section, sectionIndex) => (
                <div key={section.id} className="mb-6">
                  <h3 className="text-lg font-extrabold text-purple-700 dark:text-purple-300 mb-3">{section.title}</h3>

                  {section.questions.map((question, questionIndex) => (
                    <div key={question.id} className="mb-4 p-4 bg-gradient-to-br from-purple-50 via-fuchsia-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl border border-purple-200 dark:border-purple-700 shadow-md">
                      <div className="mb-3">
                        ...
                        {question.description && (
                          <p className="text-sm text-purple-700 dark:text-purple-300 mt-1">{question.description}</p>
                        )}
                      </div>
