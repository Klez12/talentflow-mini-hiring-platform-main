    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            <div className="w-14 h-14 bg-gradient-to-br from-purple-600 via-fuchsia-500 to-indigo-700 rounded-2xl shadow-lg flex items-center justify-center">
              <DocumentTextIcon className="w-7 h-7 text-white" />
            </div>
            <div>
              <h3 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-fuchsia-500 to-indigo-700 dark:from-purple-400 dark:via-fuchsia-400 dark:to-indigo-500">
                <span className="text-magenta-600 dark:text-magenta-400">Assessment Submissions</span>
              </h3>
              <p className="text-lg font-bold text-purple-700 dark:text-purple-300">
                <span className="text-magenta-600 dark:text-magenta-400">{jobTitle}</span>
              </p>
            </div>
          </div>
        ...
        {submissions.length > 0 && assessment && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div className="bg-gradient-to-br from-purple-50 via-fuchsia-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl border border-purple-200 dark:border-purple-700 shadow-md p-4">
      ...
      {submissions.length === 0 ? (
        <Card className="p-12 text-center">
          <UserIcon className="w-16 h-16 text-purple-300 mx-auto mb-4" />
          <h4 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-fuchsia-500 to-indigo-700 dark:from-purple-400 dark:via-fuchsia-400 dark:to-indigo-500 mb-2">
            No Submissions Yet
          </h4>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <div className="relative">
                            <div className="w-14 h-14 bg-gradient-to-br from-purple-600 via-fuchsia-500 to-indigo-700 rounded-full shadow-lg flex items-center justify-center">
                              <UserIcon className="w-7 h-7 text-white" />
                            </div>
                            <div className="absolute -top-1 -right-1 w-7 h-7 bg-gradient-to-br from-green-400 via-green-500 to-green-600 rounded-full flex items-center justify-center shadow">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-2">
                              <h4 className="text-lg font-extrabold text-purple-700 dark:text-purple-300">
                                Candidate #{submission.candidateId.slice(-4)}
                              </h4>
                              {assessment?.enableScoring ? (
                                <div className={`px-3 py-1 rounded-full text-sm font-bold ${scoreBg} ${scoreColor} shadow-md`}>Score: {score}%</div>
                              ) : (
                                <div className="px-3 py-1 rounded-full text-sm font-bold bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400 shadow-md">Manual Review</div>
                              )}
                            </div>
                            <div className="flex items-center space-x-6 text-sm text-purple-700 dark:text-purple-300">
                        ...
                        <Button
                          ...
                          className="ml-4 bg-gradient-to-r from-purple-600 via-fuchsia-500 to-indigo-700 text-white font-bold shadow-md border-none"
                        >
                          View Details
                        </Button>
                      </div>
        ...
        {selectedSubmission && assessment && (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="w-20 h-20 bg-gradient-to-br from-purple-600 via-fuchsia-500 to-indigo-700 rounded-2xl shadow-lg flex items-center justify-center">
                    <UserIcon className="w-10 h-10 text-white" />
                  </div>
                  <div>
                    <h4 className="text-2xl font-extrabold text-purple-700 dark:text-purple-300 mb-1">
                ...
                <div className="text-right">
                  {assessment.enableScoring ? (
                    <>
                      <div className="text-4xl font-extrabold text-purple-700 dark:text-purple-300 mb-1">
              ...
              {questionsWithAnswers.length > 0 ? (
                <div className="space-y-4 max-h-96 overflow-y-auto">
                  {questionsWithAnswers.map((qa, index) => (
                    <div key={qa.id} className={`border rounded-2xl p-4 shadow-md bg-gray-900 border-gray-800`}> 
