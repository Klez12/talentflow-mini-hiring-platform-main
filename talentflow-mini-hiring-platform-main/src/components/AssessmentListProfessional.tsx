    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            <h1 className="text-3xl font-extrabold text-purple-900 dark:text-purple-300 mb-2">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-50 via-fuchsia-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl border border-purple-200 dark:border-purple-700 shadow-md p-6 mb-8"
        >
          <h2 className="text-xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-fuchsia-500 to-indigo-700 dark:from-purple-400 dark:via-fuchsia-400 dark:to-indigo-500 mb-4">Create New Assessment</h2>
          
          {jobsWithoutAssessments.length > 0 ? (
            <div className="flex flex-col sm:flex-row gap-4">
              <select
                className="flex-1 px-4 py-2 border border-blue-900 dark:border-blue-900 rounded-lg bg-blue-900 dark:bg-blue-900 text-white font-bold focus:ring-2 focus:ring-blue-900 focus:border-blue-900 shadow-md"
                onChange={(e) => {
                  if (e.target.value) {
                ...
                defaultValue=""
              >
                <option value="" className="text-blue-900 dark:text-blue-200 font-bold">Select a job to create assessment...</option>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-50 via-fuchsia-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl border border-purple-200 dark:border-purple-700 shadow-md"
        >
          ...
          {assessments.length > 0 ? (
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
              {assessments.map((assessment) => (
                <div key={assessment.id} className="p-6 bg-gradient-to-br from-purple-100 via-fuchsia-100 to-indigo-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-xl shadow-md border border-purple-200 dark:border-purple-700 hover:shadow-lg transition-all duration-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-fuchsia-500 to-indigo-700 dark:from-purple-400 dark:via-fuchsia-400 dark:to-indigo-500">
                          {assessment.title || 'Untitled Assessment'}
                        </h3>
                        <span className="px-2 py-1 text-xs font-bold bg-gradient-to-r from-purple-200 via-fuchsia-200 to-indigo-300 text-purple-700 dark:bg-gradient-to-r dark:from-purple-700 dark:via-fuchsia-700 dark:to-indigo-800 dark:text-purple-200 rounded-full shadow">
                          {jobs.find(j => j.id === assessment.jobId)?.title || 'Unknown Job'}
                        </span>
                      </div>
                      
                      <p className="text-gray-600 dark:text-gray-400 mb-3">
                        <span className="text-purple-700 dark:text-purple-300">{assessment.description || 'No description provided'}</span>
                      </p>
